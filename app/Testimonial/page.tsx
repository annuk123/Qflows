...
const [editedReview, setEditedReview] = useState({
  ...
  //   try {
  //     const updatedReview = {
  //       userName: userName || editingReview.userName,
  //       place: userPlace || editingReview.place,
  //       rating: userRating || editingReview.rating,
  //       review: userReview || editingReview.review,
  //       avatarUrl: editingReview.avatarUrl, // Keep the existing avatar URL
  //     };
  ...
  //         t.id === editingReviewId ? { ...t, ...editedReview } : t
  //       )
  //     );
